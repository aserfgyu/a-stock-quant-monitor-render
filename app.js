class QM {
    ...
    sk() {
        ...
        if(!app)return;
        app.innerHTML=`<div class="header"><div><h1>A股量化全景监控中心</h1><div class="sub">多因子评分 · 技术信号 · 资金流向 · 实时量化</div></div><div class="header-right"><div class="dot"></div><span id="cs">连接中...</span><span style="margin:0 6px;color:var(--tt)">|</span><span id="ut">--</span></div></div>
