...
from config import HOST, PORT, ALL_SYMBOLS, UPDATE_INTERVAL, CORS_ORIGINS
from data_fetcher import DataFetcher
from quant_engine import QuantEngine

app_state = {'data':{}, 'results':{}, 'chart_data':{}, 'last_update':None, 'clients':set()}
fetcher = DataFetcher(use_ifind=False)
...
# Static files - Render uses /app/frontend
...
def root():
    ...
    return {"msg":"A股量化监控API运行中","version":"1.0.0"}
